...
#
#     spack install lardataobj
#
# You can edit this file again by typing:
#
#     spack edit lardataobj
#
...
class Lardataobj(Package):
    ...
    homepage='http://cdcvs.fnal.gov/projects/lardataobj',

    version(
        'v1_15_02',
        git='http://cdcvs.fnal.gov/projects/lardataobj',
        tag='v1_15_02')
    ...
    depends_on("nusimdata@v1_07_01",when='@v1_15_02')
    depends_on("larcoreobj@v1_13_01",when='@v1_15_02')
    depends_on("canvas+nu@v1_06_04^ups-root-table+nu",when='@v1_15_02')
